import { sortBadges, getTotalBadges, getTotalStats } from "../helpers";
...
export function formatPlayerObject(player) {
    const playerInfo = {
        ...
        secondary_position: player.secondary_position, height: player.height, weight: player.weight, wingspan: player.wingspan
    }
    ...
    const ballHandleA = {
        dribble_style_a: player.dribble_style_a, size_up_packages_a: player.size_up_packages_a, moving_crossover_a: player.moving_crossover_a, 
