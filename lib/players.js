...
export async function getAllPlayers() {
    ...
    const query = session.query({ collection: "Players" })
...
export async function getAllPlayersWithAllStats() {
    ...
    const query = session.query({ collection: "Players" })
    .selectFields([
        "name", "collection", "theme", "team", "college", "overall", "off_overall", "def_overall", "position", "secondary_position", "height", "weight",
        "shot_close", "shot_mid", "shot_3pt", "shot_iq", "free_throw", "offensive_consistency", "driving_layup", "standing_dunk", "driving_dunk", "draw_foul",
        "post_moves", "post_hook", "post_fade", "hands", "speed", "acceleration", "vertical", "strength", "stamina", "hustle", "speed_with_ball",
