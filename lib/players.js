...
export function getAllAnimations(allPlayers) {
    ...
    return { 
        ...
        hop_jumper_a: Array.from(new Set(hop_jumper_a)), dribble_style_a: Array.from(new Set(dribble_style_a)), size_up_packages_a: Array.from(new Set(size_up_packages)),
