...
export async function getAllPlayersWithAllStats() {
    ...
    .selectFields([
        ...
        "passing_accuracy", "passing_vision", "passing_iq", "interior_defense", "perimeter_defense", "help_defense_iq", "lateral_quickness", "pass_perception", "steal",
        "block", "defensive_consistency", "offensive_rebound", "defensive_rebound", "intangibles", "potential", "backdown_punisher", "consistent_finisher", "contact_finisher",
        ...
        "spin_layup_t", "hop_step_layup_t", "euro_step_layup_t", "step_through_shot_t", "shot_mid_t", "shot_3pt_t", "spot_up_shot_3pt_t", "spin_jumper_t", 
        "transition_pull_up_3pt_t", "drive_t", "spot_up_drive_t", "off_screen_drive_t", "attack_strong_on_drive_t", "roll_vs_pop_t", "transition_spot_up_t", "play_discipline_t",
        "flashy_pass_t", "alley_oop_pass_t", "pass_interception_t", "take_charge_t", "on_ball_steal_t", "contest_shot_t", "block_shot_t", "foul_t", "hard_foul_t", 
        "lower_base_a", "upper_release_a", "contested_a", "free_throw_a", "leaner_a", "spin_jumper_a", "hop_jumper_a", "dribble_style_a", "size-up_packages_a", 
        "moving_crossover_a", "moving_behind_the_back_a", "moving_spin_a", "moving_hesitation_a", "triple_threat_style_a", "post_fade_a", "post_hook_a",
        "post_hop_shot_a", "post_shimmy_fade_a", "post_spin_shot_a", "layup_package_a", "go_to_dunk_a", "date", "is_evo", "is_duo"
    ]);
