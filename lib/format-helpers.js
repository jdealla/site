...
export function formatDuoObject(player) {
    const shootingStats = {
...
export function formatBasicPlayerObject(player) {
    const playerInfo = {
        id: player.id, name: player.name, collection: player.collection, theme: player.theme, team: player.team, 
        overall: player.overall, off_overall: player.off_overall, def_overall: player.def_overall, position: player.position, 
        secondary_position: player.secondary_position, height: player.height, weight: player.weight
    }
    ...
    const layupA = {
        layup_package_a: player.layup_package_a
    }
