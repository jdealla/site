...
export function getTotalStats(player) {
    let stats = [
        player.shot_close, player.shot_mid, player.shot_3pt, player.free_throw, player.offensive_consistency, player.driving_layup, player.standing_dunk, 
        ...
        player.passing_accuracy, player.passing_vision, player.speed, player.acceleration, player.vertical, player.strength, player.stamina, player.hustle,
