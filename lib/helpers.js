...
export function getTotalStats(player) {
    let stats = [
        player.shot_close, player.shot_mid, player.shot_3pt, player.shot_iq, player.free_throw, player.offensive_consistency, player.driving_layup, player.standing_dunk, 
        player.driving_dunk, player.draw_foul, player.post_moves, player.post_hook, player.post_fade, player.hands, player.speed_with_ball, player.ball_handle, 
        player.passing_accuracy, player.passing_vision, player.passing_iq, player.speed, player.acceleration, player.vertical, player.strength, player.stamina, player.hustle,
        player.interior_defense, player.perimeter_defense, player.help_defense_iq, player.lateral_quickness, player.pass_perception, player.steal, player.block,
        player.defensive_consistency, player.offensive_rebound, player.defensive_rebound
    ];
