export default function ShotChart(props) {
    ...
    return (
        <svg viewBox="0 0 300 250">
            ...
            <polygon className="hz_mid_left_corner" points="20,0 20,130 40,150 90,115 70,95 70,0" strokeWidth="2" stroke="#EAEAEA" fill={hotzones.hz_mid_left_corner === "Hot" ? "#ED1B24" : hotzones.hz_mid_left_corner === "Cold" ? "#2323d6" : "#828282"}></polygon>
            ...
            <polygon className="hz_mid_left" points="1,175 90,115 112,133 125,140 105,190" strokeWidth="2" stroke="#EAEAEA" fill={hotzones.hz_mid_left === "Hot" ? "#ED1B24" : hotzones.hz_mid_left === "Cold" ? "#2323d6" : "#828282"}></polygon>
            ...
            <polygon className="hz_mid_right" points="299,175 210,115 188,133 175,140 195,190" strokeWidth="2" stroke="#EAEAEA" fill={hotzones.hz_mid_right === "Hot" ? "#ED1B24" : hotzones.hz_mid_right === "Cold" ? "#2323d6" : "#828282"}></polygon>
            ...
            <polygon className="hz_mid_right_corner" points="280,0 280,130 260,150 210,115 230,95 230,0" strokeWidth="2" fill={hotzones.hz_mid_right_corner === "Hot" ? "#ED1B24" : hotzones.hz_mid_right_corner === "Cold" ? "#2323d6" : "#828282"} stroke="#EAEAEA"></polygon>
